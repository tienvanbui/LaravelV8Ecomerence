...
<div class="container">
  ...
  <div class="row">
   <h1 class="text-center">Edit User Role</h1>
   @if ($errors->any())
        ...
        'role'=>$role->id
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <textarea name="display_name" id="ckeditor_user_role_edit" cols="30" rows="10" class="form-control" placeholder="Enter Role Description">{{$role->display_name}}</textarea>
            </div>
          </div>
            <div class="col-md-12">
                <div class="row">
              ...
              <div class="card text-white col-md-12 mb-3">
                ...
                <div class="card-body col-md-3 ml-1">
                    <h5 class="card-title">
                    <label>
                      <input type="checkbox" name="permission_id[]" class="checkbox_childrent" value={{$child->id}} multiple  {{$pemissionOfRoles->contains('id',$child->id) ? 'checked': ''}}>
                    </label>
