        ...
        'role'=>$role->id
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <textarea name="display_name" id="ckeditor_user_role_show" cols="30" rows="10" class="form-control" placeholder="Enter Role Description">{{$role->display_name}}</textarea>
            </div>
          </div>
            <div class="col-md-12">
                <div class="row">
