...
<div class="container">
    ...
    <div class="row">
        <div class="container">
            ...
            <form action="{{route('slide.update',[
                'slide'=>$slider->id,
                ...
                @method('put')
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" aria-describedby="name"  name="name" value="{{$slider->name}}">
                </div>
                <div class="form-group">
                    ...
                    <img src="{{asset($slider->img_slider)}}" width="60%" height="40%">
                </div>
                 <div class="form-group">
                    <label for="des">Description</label>
                    <textarea name="des"cols="30" rows="10" class="form-control" id="ckeditor_slider_edit">{{$slider->des}}</textarea>
                </div>
