...
<section class="bg0 p-t-62 p-b-60">
  <div class="container">
    ...
    'blog' => $blogItem->id,
                ...
                <img src="{{ $blogItem->thumbnail }}" alt="img-blog">

                <div class="flex-col-c-m size-123 bg9 how-pos5">
                  <span class="ltext-107 cl2 txt-center">
                    {{ $blogItem->updated_at->format('d') }}
                  </span>

                  <span class="stext-109 cl3 txt-center">
                    {{ $blogItem->updated_at->format('M Y') }}
                  </span>
                </div>
              </a>
    ...
    'blog' => $blogItem->id,
                ...
                <p class="stext-117 cl6">
                   {!! substr ($blogItem->blog_content,0,300).'....'!!}
                </p>

                <div class="flex-w flex-sb-m p-t-18">
                  <span class="flex-w flex-m stext-111 cl2 p-r-30 m-tb-10">
                    <span>
                      <span class="cl4">By</span>: {{ $blogItem->user->username }}
                    ...
                    <span>
                      @php
                        $stringTags = '';
                        foreach ($blogItem->tags as $tagItem) {
